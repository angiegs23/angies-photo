...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://formspree.io/f/xanyyjpe', {
        method: 'POST',
        headers: {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-charcoal/70 text-lg max-w-2xl mx-auto">
            Ready to book a session? Get in touch and let's create memories that last forever.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-12 h-12 bg-copper hover:bg-charcoal rounded-full flex items-center justify-center transition-colors duration-300"
          ...
          >
            ...
            <div>
              <label htmlFor="service" className="block text-charcoal font-semibold mb-2">
                Service Interest *
              </label>
              <select
                id="service"
            ...
            <div>
              ...
              <textarea
                ...
                required
                rows="5"
                className="w-full px-4 py-3 border border-neutral rounded-lg focus:outline-none focus:border-copper transition-colors resize-none"
            ...
            <button
              ...
              className="w-full bg-gold hover:bg-copper text-charcoal font-semibold px-8 py-4 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
            >
            ...
            {submitStatus === 'error' && (
              <div className="mt-4 p-4 bg-red-50 border border-red-200 rounded-lg">
                <p className="text-red-800 text-center">
                  ✗ Oops! Something went wrong. Please try again or email me directly at angieshvaya.photo@gmail.com
                </p>
              </div>
            )}
          </motion.form>
